...
<p align="center">
<a href="#"><img title="soofi Crack" src=".__src__/sooficrk.png"></a>
<p align="center">
...
<a href="https://github.com/htr-tech/sooficrack/network/members"><img title="Forks" src="https://img.shields.io/github/forks/htr-tech/afgcrack?color=red&style=flat-square"></a>
<a href="https://github.com/htr-tech/sooficrack/watchers"><img title="Watching" src="https://img.shields.io/github/watchers/htr-tech/afgcrack?label=Watchers&color=blue&style=flat-square"></a>
</p>
...
* `git clone https://github.com/htr-tech/sooficrack.git`
* `cd sooficrack`
...
## Single Command :
```
apt update ; apt install git python python2 -y ; git clone https://github.com/htr-tech/sooficrack.git ; cd sooficrack ; python2 crack.py
```
